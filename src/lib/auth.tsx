...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  function temPermissao(chave: PermissionKey) {
    ...
    // Fora do modo demo: admin e professor têm acesso operacional pleno por padrão.
    // Uma matriz de permissões equivalente pode ser modelada como tabela no Supabase.
    return perfil.role === 'admin' || perfil.role === 'professor'
  }
